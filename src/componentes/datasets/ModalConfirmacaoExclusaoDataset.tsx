...
interface ModalConfirmacaoExclusaoDatasetProps {
  nomeDataset: string;
  aberto: boolean;
  carregando: boolean;
  erro?: string | null;
...
const ModalConfirmacaoExclusaoDataset: React.FC<ModalConfirmacaoExclusaoDatasetProps> = ({
  nomeDataset,
  aberto,
  carregando,
  erro,
      ...
      <div className="w-full max-w-lg rounded-3xl border border-slate-200 bg-white p-8 shadow-2xl">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900">Excluir dataset</h2>
              <p className="mt-1 text-sm text-slate-500">
                Esta acao remove o dataset, o arquivo enviado e as analises relacionadas.
              </p>
            </div>
          </div>
        ...
        <div className="mt-6 rounded-2xl border border-red-100 bg-red-50 p-4">
          <p className="text-sm text-red-700">
            Voce esta prestes a excluir <span className="font-bold">{nomeDataset}</span>.
          </p>
        </div>
...
export default ModalConfirmacaoExclusaoDataset;
